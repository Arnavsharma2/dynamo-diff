...
This is a public software release with measured compiler evidence. VS Code extension 0.1.1 was subsequently [published on Marketplace](https://marketplace.visualstudio.com/items?itemName=dynamo-diff.dynamo-diff); its [separate receipt](../artifacts/marketplace-publication.json) identifies the verified package. Python analyzer 0.1.1 was later [published on PyPI](https://pypi.org/project/dynamo-diff/0.1.1/), with [verified public downloads and installations](../artifacts/pypi-publication-0.1.1.json). There is no external adoption claim, CUDA/Inductor speedup claim or demonstrated end-to-end agent improvement. The 60-attempt pilot's negative primary result remains unchanged. Reviews are AI-reviewed under the approved scope; independent human review remains optional and unclaimed.

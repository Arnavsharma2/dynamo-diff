...
- Distribute a wheel, source archive, VSIX and 72-second visual CLI walkthrough through GitHub Releases, with installation instructions, checksums and build evidence.
